...
function add_menuclass($ulclass) {
    return preg_replace('/<a /', '<a class="dropdown-btn menu-header-navigation-item"', $ulclass);
 }
...
function change_submenu_class($dropdownmenu) {  
    return preg_replace('/ class="sub-menu"/','/ class="dropdown-links" /',$dropdownmenu);   
}  
...
add_filter( 'nav_menu_link_attributes', 'wpse270596_add_navlink_atts');
 */
...
add_image_size('luis_size',1920,255);
